...
# args.root = "/home/cjh/cjh/ucf101_frame"
# args.train_list = "data/ucf101/ucf101_rgb_train_split_1.txt"
# args.val_list = "data/ucf101/ucf101_rgb_val_split_1.txt"
class I3dDataSet(data.Dataset):
    ...
    def _load_image(self, directory, idx):
        ...
        if self.modality == 'rgb' or self.modality == 'RGBDiff' or self.modality == 'RGB':
            ...
            #img = img.resize((256,340), Image.ANTIALIAS)
            return [img]
            ...
            if self.dataset == 'ucf101':
                u_img_path = '/home/wjp/Data/tvl1_flow/u/' + directory.strip().split(' ')[0].split('/')[-1] + '/frame'+ str(idx).zfill(6) + '.jpg'
                v_img_path = '/home/wjp/Data/tvl1_flow/v/' + directory.strip().split(' ')[0].split('/')[-1] + '/frame'+ str(idx).zfill(6) + '.jpg'
